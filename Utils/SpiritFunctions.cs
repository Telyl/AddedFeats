...
namespace AddedFeats.Utils
{
    ...
    /// </summary>
    public class SpiritFunctions
    {
        public static BlueprintAbility CreateSpiritFocusAbility(string abilityname, string abilityguid, string displayname, string description, UnityEngine.Sprite Icon, BlueprintBuff bpbuff, BlueprintAbilityResource spiritsgiftresource)
        {
            return AbilityConfigurator.New(abilityname, abilityguid)
                ...
                .AddFactContextActions(ActionsBuilder.New().ApplyBuffPermanent(bpbuff))
                //.SetBuff(bpbuff)
                //.SetGroup(activeability)
