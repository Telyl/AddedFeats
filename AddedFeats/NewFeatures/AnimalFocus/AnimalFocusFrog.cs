...
namespace AddedFeats.NewFeatures.AnimalFocus
{
    ...
    {
        private static readonly string FeatName = "AnimalFocusFrog";
        private static readonly string DisplayName = "AnimalFocusFrog.Name";
        private static readonly string Description = "AnimalFocusFrog.Description";

        private static readonly string FocusAnimalBuff = Guids.AnimalFocusFrogBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.AnimalFocusFrogFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.AnimalFocusFrogBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.AnimalFocusFrogBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.AnimalFocusFrogActivatableAbility;
        private static readonly UnityEngine.Sprite icon = AbilityRefs.Grace.Reference.Get().Icon;
