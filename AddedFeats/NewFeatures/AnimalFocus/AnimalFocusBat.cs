...
namespace AddedFeats.NewFeatures.AnimalFocus
{
    ...
    {
        private static readonly string FeatName = "AnimalFocusBat";
        private static readonly string DisplayName = "AnimalFocusBat.Name";
        private static readonly string Description = "AnimalFocusBat.Description";

        private static readonly string FocusAnimalBuff = Guids.AnimalFocusBatBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.AnimalFocusBatFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.AnimalFocusBatBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.AnimalFocusBatBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.AnimalFocusBatActivatableAbility;

        private static readonly UnityEngine.Sprite icon = AbilityRefs.AnimalAspectBase.Reference.Get().Icon;
