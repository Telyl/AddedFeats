...
{
    internal class AnimalFocusSnake
    {
        private static readonly string FeatName = "AnimalFocusSnake";
        private static readonly string DisplayName = "AnimalFocusSnake.Name";
        private static readonly string Description = "AnimalFocusSnake.Description";

        private static readonly string FocusAnimalBuff = Guids.AnimalFocusSnakeBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.AnimalFocusSnakeFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.AnimalFocusSnakeBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.AnimalFocusSnakeBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.AnimalFocusSnakeActivatableAbility;
        private static readonly UnityEngine.Sprite icon = AbilityRefs.BloodragerSerpentineFormAbility.Reference.Get().Icon;
        ...
        public static void Configure()
        {
            ...
            FeatureConfigurator.For(FeatureRefs.HunterAnimalFocusFeature)
                .EditComponent<AddFacts>(
                    c => c.m_Facts =
                        CommonTool.Append(
                        c.m_Facts, BlueprintTool.GetRef<BlueprintUnitFactReference>(FocusActivatableAbility)))
                .Configure();
