...
namespace AddedFeats.NewFeatures.AnimalFocus
{
    ...
    {
        private static readonly string FeatName = "AnimalFocusWolf";
        private static readonly string DisplayName = "AnimalFocusWolf.Name";
        private static readonly string Description = "AnimalFocusWolf.Description";

        private static readonly string FocusAnimalBuff = Guids.AnimalFocusWolfBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.AnimalFocusWolfFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.AnimalFocusWolfBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.AnimalFocusWolfBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.AnimalFocusWolfActivatableAbility;

        private static readonly UnityEngine.Sprite icon = AbilityRefs.AspectOfTheWolf.Reference.Get().Icon;
