...
namespace AddedFeats.NewFeatures.FavoredAnimalFocus
{
    ...
    /// </summary>
    internal class FavoredAnimalFocusBull
    {
        ...
        private static readonly string FavoredAnimalFocusCharacter = Guids.FavoredAnimalFocusBull;
        private static readonly string FavoredAnimalFocusPet = Guids.FavoredAnimalFocusBullPet;
        private static readonly string FavoredAnimalFocusBuff = Guids.FavoredAnimalFocusBullBuff;
        private static readonly StatType FavoredAnimalFocusStat = StatType.Strength;
