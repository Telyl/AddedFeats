...
namespace AddedFeats.NewFeatures.FavoredAnimalFocus
{
    ...
    /// </summary>
    internal class FavoredAnimalFocusBear
    {
        ...
        private static readonly string FavoredAnimalFocusCharacter = Guids.FavoredAnimalFocusBear;
        private static readonly string FavoredAnimalFocusPet = Guids.FavoredAnimalFocusBearPet;
        private static readonly string FavoredAnimalFocusBuff = Guids.FavoredAnimalFocusBearBuff;
