...
namespace AddedFeats.NewFeatures.FavoredAnimalFocus
{
    ...
    internal class FavoredAnimalFocusFalcon
    {
        ...
        private static readonly string FavoredAnimalFocusCharacter = Guids.FavoredAnimalFocusFalcon;
        private static readonly string FavoredAnimalFocusPet = Guids.FavoredAnimalFocusFalconPet;
        private static readonly string FavoredAnimalFocusBuff = Guids.FavoredAnimalFocusFalconBuff;
        private static readonly StatType FavoredAnimalFocusStat = StatType.SkillPerception;
