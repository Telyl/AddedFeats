...
namespace AddedFeats.NewFeatures.FavoredAnimalFocus
{
    ...
    internal class FavoredAnimalFocusStag
    {
        ...
        private static readonly string FavoredAnimalFocusCharacter = Guids.FavoredAnimalFocusStag;
        private static readonly string FavoredAnimalFocusPet = Guids.FavoredAnimalFocusStagPet;
        private static readonly string FavoredAnimalFocusBuff = Guids.FavoredAnimalFocusStagBuff;
        private static readonly StatType FavoredAnimalFocusStat = StatType.Speed;
        private static readonly ModifierDescriptor FavoredAnimalFocusDescriptor = ModifierDescriptor.Enhancement;
