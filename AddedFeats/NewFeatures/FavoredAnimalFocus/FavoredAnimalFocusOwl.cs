...
namespace AddedFeats.NewFeatures.FavoredAnimalFocus
{
    ...
    /// </summary>
    internal class FavoredAnimalFocusOwl
    {
        ...
        private static readonly string FavoredAnimalFocusCharacter = Guids.FavoredAnimalFocusOwl;
        private static readonly string FavoredAnimalFocusPet = Guids.FavoredAnimalFocusOwlPet;
        private static readonly string FavoredAnimalFocusBuff = Guids.FavoredAnimalFocusOwlBuff;
        private static readonly StatType FavoredAnimalFocusStat = StatType.SkillStealth;
