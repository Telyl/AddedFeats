...
{
    internal class PlanarFocusWater
    {
        ...
        private static readonly string FocusAnimalBuff = Guids.PlanarFocusWaterBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.PlanarFocusWaterFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.PlanarFocusWaterBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.PlanarFocusWaterBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.PlanarFocusWaterActivatableAbility;

        private static readonly UnityEngine.Sprite icon = AbilityRefs.WaterBlastAbility.Reference.Get().Icon;
