...
{
    internal class PlanarFocusGood
    {
        ...
        private static readonly string FocusAnimalBuff = Guids.PlanarFocusGoodBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.PlanarFocusGoodFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.PlanarFocusGoodBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.PlanarFocusGoodBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.PlanarFocusGoodActivatableAbility;

        private static readonly UnityEngine.Sprite icon = AbilityRefs.ProtectionFromGood.Reference.Get().Icon;
