...
{
    internal class PlanarFocusEvil
    {
        ...
        private static readonly string FocusAnimalBuff = Guids.PlanarFocusEvilBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.PlanarFocusEvilFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.PlanarFocusEvilBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.PlanarFocusEvilBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.PlanarFocusEvilActivatableAbility;
