...
{
    internal class PlanarFocusChaos
    {
        private static readonly string FeatName = "PlanarFocusChaos";
        ...
        private static readonly string FocusAnimalBuff = Guids.PlanarFocusChaosBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.PlanarFocusChaosFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.PlanarFocusChaosBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.PlanarFocusChaosBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.PlanarFocusChaosActivatableAbility;

        private static readonly UnityEngine.Sprite icon = AbilityRefs.ProtectionFromChaos.Reference.Get().Icon;
