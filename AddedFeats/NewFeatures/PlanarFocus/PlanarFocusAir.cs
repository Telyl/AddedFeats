...
namespace AddedFeats.NewFeatures.AnimalFocus
{
    internal class PlanarFocusAir
    {
        ...
        private static readonly string FocusAnimalBuff = Guids.PlanarFocusAirBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.PlanarFocusAirFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.PlanarFocusAirBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.PlanarFocusAirBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.PlanarFocusAirActivatableAbility;

        private static readonly UnityEngine.Sprite icon = AbilityRefs.AirBlastAbility.Reference.Get().Icon;
