...
{
    internal class PlanarFocusLawful
    {
        ...
        private static readonly string FocusAnimalBuff = Guids.PlanarFocusLawfulBuff;
        private static readonly string FocusAnimalFeatureEffect = Guids.PlanarFocusLawfulFeatureEffect;
        private static readonly string FocusAnimalBuffEffect = Guids.PlanarFocusLawfulBuffEffect;
        private static readonly string FocusAnimalBuffCharacter = Guids.PlanarFocusLawfulBuffCharacter;
        private static readonly string FocusActivatableAbility = Guids.PlanarFocusLawfulActivatableAbility;

        private static readonly UnityEngine.Sprite icon = AbilityRefs.ProtectionFromLaw.Reference.Get().Icon;
