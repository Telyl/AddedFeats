...
namespace AddedFeats.Utils
{
    internal class Guids
    {
        ...
        // Favored Animal Focus Bat
        internal const string FavoredAnimalFocusBat = "57126027149d427b9bbee58286712d28";
        internal const string FavoredAnimalFocusBatPet = "1307e361c27241e7a4b31f87923ce335";
        internal const string FavoredAnimalFocusBatBuff = "3a501e4afddd43bd958fbbe78d09b84a";
        // Favored Animal Focus Frog
        internal const string FavoredAnimalFocusFrog = "e729af1e34af4237a7107e4cecf554e6";
        internal const string FavoredAnimalFocusFrogPet = "832f330fca8b453fa0605d461df36e75";
        internal const string FavoredAnimalFocusFrogBuff = "429b9473c3a24335b025e37054d54ff4";
        // Favored Animal Focus Snake
        internal const string FavoredAnimalFocusSnake = "1ac39897829a4e58bc4eddf107836472";
        internal const string FavoredAnimalFocusSnakePet = "db59e4a7fd4c48eea2ff503eacd59b46";
        internal const string FavoredAnimalFocusSnakeBuff = "dd22fb711ca442f59785bfa4376c30fd";
        // Favored Animal Focus Wolf
        internal const string FavoredAnimalFocusWolf = "8827c8b6c9fd47aa832668697c52a7f2";
        internal const string FavoredAnimalFocusWolfPet = "37951f39a3e3473eb92443c550f39d8e";
        internal const string FavoredAnimalFocusWolfBuff = "42b5bdd593754602b44cf3304a179ed1";
        #endregion
        #region Planar Focus
        // Planar Focus
        internal const string PlanarFocusFeature = "3d64ed44-42f3-4a8f-b7ae-a927a45af820";
        // Planar Focus Air
        internal const string PlanarFocusAirBuff = "31c9d157-fb70-4997-a0b3-56f9026d1c40";
        internal const string PlanarFocusAirFeatureEffect = "31d9d157-fb70-4997-a0b3-56f9026d1c40";
        internal const string PlanarFocusAirBuffEffect = "e55cc808-4cf2-4272-88f5-bda65d0417fc";
        internal const string PlanarFocusAirBuffCharacter = "06c88e20-b823-44b9-b15f-e69fc4c6a556";
        internal const string PlanarFocusAirActivatableAbility = "56722f70-03e5-4272-9aa3-115382ae869f";
        // Planar Focus Chaotic
        internal const string PlanarFocusChaosBuff = "4828c37e-3d59-4358-a042-b9fa4fb7bb72";
        internal const string PlanarFocusChaosFeatureEffect = "db903e19-7586-45a5-ac05-3cb8b410f039";
        internal const string PlanarFocusChaosBuffEffect = "502cba69-f94a-4399-b37f-3577ad8018a2";
        internal const string PlanarFocusChaosBuffCharacter = "b5741066-de62-447c-8ba5-e265aa4e1292";
        internal const string PlanarFocusChaosActivatableAbility = "fd904798-952b-45aa-b594-0841156bdc7a";
        // Planar Focus Cold
        internal const string PlanarFocusColdBuff = "cc239df8-dfbf-49d2-86ca-ea462717ab4d";
        internal const string PlanarFocusColdFeatureEffect = "f47e182b-f8d3-4477-b78e-075fc8205892";
        internal const string PlanarFocusColdBuffEffect = "775bb39b-8d48-40d9-bed7-55f2411575dd";
        internal const string PlanarFocusColdBuffCharacter = "818f4cdb-2939-4824-90cc-118269fe5203";
        internal const string PlanarFocusColdActivatableAbility = "958b8209-4ece-4233-b592-87c3997fc073";
        // Planar Focus Earth
        internal const string PlanarFocusEarthBuff = "548da62f-f01a-420c-9528-e8bee75a7d34";
        internal const string PlanarFocusEarthFeatureEffect = "7119f97b-110a-4001-b770-8b5eb08799e5";
        internal const string PlanarFocusEarthBuffEffect = "9d3fbbc5-0609-4fe3-9cd2-53991c10620d";
        internal const string PlanarFocusEarthBuffCharacter = "6ebaa1dc-a6d2-48f9-81fa-80eb1d822b6e";
        internal const string PlanarFocusEarthActivatableAbility = "b0f6b4b8-3dc7-4197-95ad-b242db6651bd";
        // Planar Focus Evil
        internal const string PlanarFocusEvilBuff = "db542378-f53b-4d5c-ada2-461cea97a6b3";
        internal const string PlanarFocusEvilFeatureEffect = "2d294f73-f191-4309-b103-7a3eecc505b0";
        internal const string PlanarFocusEvilBuffEffect = "b81875c8-313b-473f-a16c-be34c011b579";
        internal const string PlanarFocusEvilBuffCharacter = "a54b8dd2-d0cc-44d3-bd6e-068274031a3b";
        internal const string PlanarFocusEvilActivatableAbility = "856c95f9-05a9-4dd6-89b3-6f2ebd51eef2";
        // Planar Focus Fire
        internal const string PlanarFocusFireBuff = "33628596-101f-4c2d-bcf8-e6814ddda153";
        internal const string PlanarFocusFireFeatureEffect = "456b7bc9-600b-4ac6-8a57-3f5d6061753d";
        internal const string PlanarFocusFireBuffEffect = "d2864f28-e5f9-4421-ad0f-c64f63124906";
        internal const string PlanarFocusFireBuffCharacter = "9899c88c-2e31-425b-946e-829e8666387e";
        internal const string PlanarFocusFireActivatableAbility = "595d616f-73ac-4da7-aa3b-402eeb53ee79";
        // Planar Focus Good
        internal const string PlanarFocusGoodBuff = "dc063444-4fdf-45e2-95dd-6c656be7eea0";
        internal const string PlanarFocusGoodFeatureEffect = "dd28cb24-248f-4db5-b633-8d4d5e9fcd97";
        internal const string PlanarFocusGoodBuffEffect = "0b264ada-ab69-4e83-b146-51a2cb8d5365";
        internal const string PlanarFocusGoodBuffCharacter = "ab623544-9f58-4065-a969-7b080b9745fe";
        internal const string PlanarFocusGoodActivatableAbility = "16500163-506d-4043-9ed9-05fd0ec902dd";
        // Planar Focus Lawful
        internal const string PlanarFocusLawfulBuff = "9db5c2d0-1910-4da6-ac3c-a6c57d64fd7c";
        internal const string PlanarFocusLawfulFeatureEffect = "d8cef07b-85f8-416b-80e9-da08e98f14f3";
        internal const string PlanarFocusLawfulBuffEffect = "92b8a842-5176-4d3d-9fb9-7a3a9100d80d";
        internal const string PlanarFocusLawfulBuffCharacter = "0963ac0b-d3a5-4609-9755-1c85208309a9";
        internal const string PlanarFocusLawfulActivatableAbility = "984434d3-991b-4f80-a522-3ffc949f2906";
        // Planar Focus Shadow
        internal const string PlanarFocusShadowBuff = "4389de8f-407c-43fe-88fe-3acbd3de4d79";
        internal const string PlanarFocusShadowFeatureEffect = "caa05043-9cea-48e3-94ea-01e223abfdfb";
        internal const string PlanarFocusShadowBuffEffect = "0c40850d-e56d-4cbe-98af-536287e3d742";
        internal const string PlanarFocusShadowBuffCharacter = "b1269d4f-1ae6-4d8e-8257-03fa1fc86fdb";
        internal const string PlanarFocusShadowActivatableAbility = "275b8ffc-475a-41a7-aeab-f41379cb2c73";
        // Planar Focus Water
        internal const string PlanarFocusWaterBuff = "b1b7951d-6c39-4b4b-9848-907436cacb1f";
        internal const string PlanarFocusWaterFeatureEffect = "b47bab02-098a-4b50-a244-dd4e62711658";
        internal const string PlanarFocusWaterBuffEffect = "6c912f1a-16e6-4870-b0d8-a3cb881bbfaa";
        internal const string PlanarFocusWaterBuffCharacter = "4ca8f08f-124d-4cd6-a04c-8164192f0d87";
        internal const string PlanarFocusWaterActivatableAbility = "736fd667-b68a-4e65-bee2-78cd55f3c27f";
        #endregion
        #region Spells
        ...
        internal const string VampiricCompanion = "52283e17-9213-4aee-8fc5-06c28ec0fbe8";
        #endregion
