...
namespace AddedFeats.Feats.SpiritFoci
{
    public class SpiritFocusBattle
    {
        ...
        {
            BuffConfigurator.New(FeatName + "Buff", Guids.SpiritFocusBattleBuff).Configure();
            BuffConfigurator.New(FeatName + "CustomBuff", Guids.CustomSpiritFocusBattleBuff).Configure();
            ActivatableAbilityConfigurator.New(FeatName, Guids.SpiritFocusBattle).Configure();
        }
