...
namespace AddedFeats.Feats.SpiritFoci
{
    public class SpiritFocusWaves
    {
        ...
        {
            BuffConfigurator.New(FeatName + "Buff", Guids.SpiritFocusWavesBuff).Configure();
            BuffConfigurator.New(FeatName + "CustomBuff", Guids.CustomSpiritFocusWavesBuff).Configure();
            ActivatableAbilityConfigurator.New(FeatName, Guids.SpiritFocusWaves).Configure();
        }
