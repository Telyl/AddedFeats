...
namespace AddedFeats.Feats.SpiritFoci
{
    ...
    public class SpiritFocusFlame
    {
        ...
        {
            BuffConfigurator.New(FeatName + "Buff", Guids.SpiritFocusFlameBuff).Configure();
            BuffConfigurator.New(FeatName + "CustomBuff", Guids.CustomSpiritFocusFlameBuff).Configure();
            ActivatableAbilityConfigurator.New(FeatName, Guids.SpiritFocusFlame).Configure();
        }
