...
namespace AddedFeats.Feats.SpiritFoci
{
    public class SpiritFocusWind
    {
        ...
        {
            BuffConfigurator.New(FeatName + "Buff", Guids.SpiritFocusWindBuff).Configure();
            BuffConfigurator.New(FeatName + "CustomBuff", Guids.CustomSpiritFocusWindBuff).Configure();
            ActivatableAbilityConfigurator.New(FeatName, Guids.SpiritFocusWind).Configure();
        }
