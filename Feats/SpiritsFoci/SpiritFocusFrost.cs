...
namespace AddedFeats.Feats.SpiritFoci
{
    public class SpiritFocusFrost
    {
        ...
        {
            BuffConfigurator.New(FeatName + "Buff", Guids.SpiritFocusFrostBuff).Configure();
            BuffConfigurator.New(FeatName + "CustomBuff", Guids.CustomSpiritFocusFrostBuff).Configure();
            ActivatableAbilityConfigurator.New(FeatName, Guids.SpiritFocusFrost).Configure();
        }
